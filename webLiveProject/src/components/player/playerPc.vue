<template>
  <div class="player">
    <div id="player-container" class="video-container" style="background:url('../../assets/image/myBg.png') no-repeat">
...
<style scoped lang="stylus">
  ...
  .player {
    ...
    height 100%
    .video-container {
      // background url("../../assets/image/myBg.png") no-repeat !important
