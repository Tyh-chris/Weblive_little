    ...
    methods: {
        ...
        setRenderView() {
            this.pusher.setRenderView({
                ...
                // el[0].style.background = 'url(../../assets/image/myBg.png)'
            ...
            axios(
                {
                    ...
                    method: 'get',
                    url: this.$store.state.baseUrl + '/api/live/getPusherUrl',
                    params: {userId: userId, roomId: roomId},
                }
            ).then((res) => {
                if (res.data.code === 200) {
                    let url = res.data.data.pusherUrl
                    console.log(url)
                    this.ready = true
                    this.startAnimation()
            ...
            axios(
                {
                    headers:{token:this.$store.state.token},
                    method: 'delete',
                    url: this.$store.state.baseUrl + '/api/live/stopLiveStream',
