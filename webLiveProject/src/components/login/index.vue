<template>
    <div class="login-container">
        <div class="login-wrapper">
            ...
            <!-- 腾讯云logo -->
            <div class="row-div" style="width: 100%; height: 50px; justify-content: center">
            ...
            <el-form ref="login" label-width="120" :rules="rules" :model="form" class="loginBox">
                ...
                <el-form-item prop="userPassword">
                    <div class="label-item active">
                        ...
                        <el-input id="userID" v-model="form.userPassword"
                                  placeholder=""
                                  type="text"
                                  show-password
                        >
...
<!--                </el-form-item>-->
                <el-form-item>
                    <el-button class="login-im-btn"  type="primary" @click="webLiveLogin" :loading="loading" >登录</el-button>
                </el-form-item>
            </el-form>
        </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      webLiveLogin() {
        ...
        let userPassword = this.form.userPassword
        axios(
            {
                method:'post',
            ...
            if(res.data.code == 200){
                ...
                this.$store.state.userSig = res.data.data.userSig;
                ...
                this.$store.state.conversation.showLogin=false
